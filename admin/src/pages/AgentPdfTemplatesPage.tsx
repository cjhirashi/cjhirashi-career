    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-text-secondary mt-2">
          Diseña plantillas HTML/CSS para CVs y cartas. El agente L2 agent_pdf_design las edita;
          el L3 agent_pdf_render genera el PDF de un registro o una preview vía{' '}
