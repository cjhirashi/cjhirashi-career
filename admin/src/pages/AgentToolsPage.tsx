...
const BUILTIN_TOOLS = [
  ...
  { name: 'get_pdf_template', description: 'Obtiene plantilla por id o slug (incluye style_id y variables).' },
  { name: 'create_pdf_template', description: 'Crea plantilla HTML con style_id (pds-N) y variables (Markdown).' },
  { name: 'update_pdf_template', description: 'Actualiza plantilla PDF (html, style_id, variables, etc.).' },
  { name: 'list_pdf_template_styles', description: 'Lista estilos CSS reutilizables (pds-N).' },
  { name: 'get_pdf_template_style', description: 'Obtiene estilo por id o slug (css_content + style_guide).' },
  { name: 'create_pdf_template_style', description: 'Crea estilo CSS con style_guide (Markdown de clases).' },
  { name: 'update_pdf_template_style', description: 'Actualiza estilo CSS reutilizable.' },
  { name: 'generate_pdf', description: 'Genera PDF desde plantilla + estilo referenciado.' },
