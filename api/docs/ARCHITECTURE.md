...
Arquitectura en capas de la API REST del portafolio-cjhirashi: FastAPI + SQLAlchemy 2.0 async + PostgreSQL, con integraciones Bedrock, MinIO, Qdrant y LinkedIn.
...
- Lifespan: `init_db()`, MinIO bucket, scheduler LinkedIn
