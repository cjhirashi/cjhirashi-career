...
Código de la API REST FastAPI. Único escritor de PostgreSQL del ecosistema Portafolio-cjhirashi.
...
|-----------------|---------|
| Lifecycle | `lifespan`: `init_db()`, `storage_service.ensure_bucket()`, loop `linkedin_scheduler` |
