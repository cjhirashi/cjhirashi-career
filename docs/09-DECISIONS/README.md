...
| 021 | PK sintético `sec-N` para las secciones del Admin (`system_name` como nombre legible) | ✅ Aceptado — 🔶 supersedido parcialmente por ADR-023 — ver `021-admin-sections-synthetic-pk.md` | [021-admin-sections-synthetic-pk.md](./021-admin-sections-synthetic-pk.md) |
...
| 023 | Jerarquía de secciones del Admin (grupos → L1/L2/L3 → vistas) en tablas reales + agente responsable e instrucciones por vista | ✅ Aceptado — ver `023-admin-sections-hierarchy-views.md` | [023-admin-sections-hierarchy-views.md](./023-admin-sections-hierarchy-views.md) |
| 024 | Desacoplar el nombrado del motor de agentes de "Bedrock" (`bedrock_*` → `agent_*`, excepción `engine_settings`) | 🔶 Aceptado — mapeo de nombres reemplazado por ADR-025 — ver `024-desacoplar-nombrado-motor-agentes-de-bedrock.md` | [024-desacoplar-nombrado-motor-agentes-de-bedrock.md](./024-desacoplar-nombrado-motor-agentes-de-bedrock.md) |
| 025 | Prefijo uniforme `agent_system_` para las tablas del motor de agentes (retira la excepción `engine_settings` de ADR-024) | ✅ Aceptado — pendiente de implementación — ver `025-prefijo-agent-system-motor-agentes.md` | [025-prefijo-agent-system-motor-agentes.md](./025-prefijo-agent-system-motor-agentes.md) |
